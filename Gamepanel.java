...
public class GameBoardPanel extends JPanel implements ActionListener, KeyListener{
	...
	public void step() throws Exception{
		sendData = ("Client"+ClientID+","+paddleOneX +","+ paddleOneY+","+ballX +","+ ballY).getBytes();
		...
		try {
			...
			if(ClientID==1){
				switch(pad[0]){
				case "Client2":  paddleTwoX = 1200-Integer.parseInt(pad[1]); paddleTwoY = 5;
				break;
				case "Client3":  paddleThreeY = 925-Integer.parseInt(pad[1]); paddleThreeX = 905;
				break;
				case "Client4":  paddleFourY = Integer.parseInt(pad[1])-270;paddleFourX = 275;
				break;
				}
			...
			if(ClientID==2){
				switch(pad[0]){
					case "Client1":  paddleOneX = 1200-Integer.parseInt(pad[1]);paddleOneY = 5;
					break;
					case "Client3":  paddleThreeY = Integer.parseInt(pad[1])-270;paddleThreeX = 275;
					break;
					case "Client4":  paddleFourY = 925-Integer.parseInt(pad[1]); paddleFourX = 905;
					break;
				}
			...
			if(ClientID==3){
				switch(pad[0]){
					case "Client2":  paddleTwoY= 925-Integer.parseInt(pad[1]); paddleTwoX = 905;
					break;
					case "Client1":  paddleOneY =Integer.parseInt(pad[1])-270;paddleOneX = 275;
					break;
					case "Client4":  paddleFourX = 1200-Integer.parseInt(pad[1]);paddleFourY = 5;
					break;
				}
			...
			if(ClientID==4){
				switch(pad[0]){
					case "Client2":  paddleTwoY = Integer.parseInt(pad[1])-270;paddleTwoX = 275;
					break;
					case "Client3":  paddleThreeX =  1200-Integer.parseInt(pad[1]);paddleThreeY = 5;
					break;
					case "Client1":  paddleFourY = 925-Integer.parseInt(pad[1]); paddleFourX = 905;
					break;
				}
		...
		try {
			...
			if(ClientID==2){
				switch(pad[0]){
					case "Client1":  paddleOneX = 1200-Integer.parseInt(pad[1]);paddleOneY = 5;ballX=1200-Integer.parseInt(pad[3]);ballY=655-Integer.parseInt(pad[4]);
					break;
					case "Client3":  paddleThreeY = Integer.parseInt(pad[1])-270;paddleThreeX = 275;
					break;
					case "Client4":  paddleFourY = 925-Integer.parseInt(pad[1]); paddleFourX = 905;
			...
			if(ClientID==3){
				switch(pad[0]){
					case "Client2":  paddleTwoY= 925-Integer.parseInt(pad[1]); paddleTwoX = 905;
					break;
					case "Client1":  paddleOneY =Integer.parseInt(pad[1])-270;paddleOneX = 275;ballX=1200-Integer.parseInt(pad[3]);ballY=Integer.parseInt(pad[4]);
					break;
					case "Client4":  paddleFourX = 1200-Integer.parseInt(pad[1]);paddleFourY = 5;
					break;
				}
			...
			if(ClientID==4){
				switch(pad[0]){
					...
					case "Client3":  paddleThreeX =  1200-Integer.parseInt(pad[1]);paddleThreeY = 5;
					break;
					case "Client1":  paddleFourY = 925-Integer.parseInt(pad[1]); paddleFourX = 905;ballX=Integer.parseInt(pad[3]);ballY=655-Integer.parseInt(pad[4]);
					break;
				}
				paddleFourX=270+paddleFourY;paddleFourY=635;
			}
