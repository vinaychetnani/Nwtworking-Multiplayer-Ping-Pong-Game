...
public class GameBoardPanel extends JPanel implements ActionListener, KeyListener{
	...
	public void step() throws Exception{
		switch(ClientID){
			...
			break;
			case 2:  sendData = ("Client1"+","+paddleTwoX +","+ paddleTwoY).getBytes();
			break;
			case 3:  sendData = ("Client1"+","+paddleThreeX +","+ paddleThreeY).getBytes();
			break;
			case 4:  sendData = ("Client1"+","+paddleFourX +","+ paddleFourY).getBytes();
			break;
		}
		...
		try {
			...
			if(ClientID==2){
				switch(pad[0]){
					case "Client1":  paddleOneX = 1200-Float.valueOf(pad[1]);paddleOneY = 5;
					break;
			...
			if(ClientID==3){
				switch(pad[0]){
					...
					break;
					case "Client1":  paddleOneY =Float.valueOf(pad[1])-270;paddleOneX = 275;
					break;
			...
			if(ClientID==4){
				switch(pad[0]){
					...
					break;
					case "Client1":  paddleFourY = 925-Float.valueOf(pad[1]); paddleFourX = 905;
					break;
				}
