...
public class GameBoardPanel extends JPanel implements ActionListener, KeyListener{
	...
	public GameBoardPanel(int ID,InetAddress ip2,int port2,InetAddress ip3,int port3,InetAddress ip4,int port4,DatagramSocket clientSocket1,DatagramPacket receivePacket1){
		...
		case 1:
			break;
		case 2:
			 paddleOneX = 1202 - paddleOneX - paddleOneLength;
			 paddleOneY = 657 - paddleOneY - paddleWidth;
	
			 paddleTwoX = 1202 - paddleTwoX - paddleTwoLength;
			 paddleTwoY = 657 - paddleTwoY - paddleWidth;
			 paddleThreeX = 1202 - paddleThreeX - paddleWidth;
			 paddleThreeY = 657 - paddleThreeY - paddleThreeLength;
			
			 paddleFourX = 1202 - paddleFourX - paddleWidth;
			 paddleFourY = 657 - paddleFourY - paddleFourLength;
			 break;
		case 3:
			 paddleOneX = 270 + 657 - paddleOneY - paddleWidth;
			 paddleOneY = paddleOneX - 270;
	
			 paddleTwoX =  270 + 657 - paddleTwoY - paddleWidth;
			 paddleTwoY = paddleTwoX - 270;
			 paddleThreeX = 270 + 657 - paddleThreeY - paddleThreeLength;
			 paddleThreeY = paddleThreeX - 270;
			
			 paddleFourX = 270 + 657 - paddleFourY - paddleFourLength;
			 paddleFourY = paddleFourX - 270;
			 break;
		case 4:
			 paddleOneX = paddleOneY + 270;
			 paddleOneY = 1202 - paddleOneX - paddleOneLength - 270;
	
			 paddleTwoX = paddleTwoY + 270;
			 paddleTwoY = 1202 - paddleTwoX - paddleTwoLength - 270;
			 paddleThreeX = paddleThreeY + 270;
			 paddleThreeY = 1202 - paddleThreeX - paddleWidth - 270;
			
			 paddleFourX = paddleFourY + 270;
			 paddleFourY =  1202 - paddleFourX - paddleWidth - 270;
			 break;
	...
	try {
		...
		if(ClientID == 1)
			switch(pad[0]){
			case "Client2":
				paddleTwoX = 1202 - Float.valueOf(pad[1]) - paddleTwoLength;
				break;
			case "Client3":
				paddleThreeY = 1202 - 270 - Float.valueOf(pad[1]) - paddleThreeLength;
				break;
			case "Client4":
		...
		if(ClientID == 2)
			switch(pad[0]){
			case "Client1":
				paddleOneX = 1202 - Float.valueOf(pad[1]) - paddleOneLength;
				ballX = 1202 - Float.valueOf(pad[3]) - ballDiameter;
				ballY= 657 - Float.valueOf(pad[4]) - ballDiameter;
				break;
			case "Client3":
				paddleThreeY = Float.valueOf(pad[1]) - 270;
				break;
			case "Client4":
				paddleFourY = 1202 - 270 - Float.valueOf(pad[1]) - paddleFourLength;
			}
		...
		if(ClientID == 3)
			...
			case "Client1":
				...
				ballX = 1202 - 270 - Float.valueOf(pad[4]) - ballDiameter;
				ballY = Float.valueOf(pad[3]) - 270;
				break;
			case "Client2":  
				paddleTwoY = 1202 - 270 - Float.valueOf(pad[1]) - paddleTwoLength;
				break;
			case "Client4":
				paddleFourX = 1202 - Float.valueOf(pad[1]) - paddleFourLength;
			}
		
		if(ClientID == 4)
			switch(pad[0]){
			case "Client1":
				paddleOneY = 1202 - 270 - Float.valueOf(pad[1]) - paddleOneLength;
				ballX = Float.valueOf(pad[4]) + 270;
				ballY = 1202 - 270 - Float.valueOf(pad[3]) - ballDiameter;
				break;
			case "Client2":
				paddleTwoY = Float.valueOf(pad[1]) - 270;
				break;
			case "Client3":
				paddleThreeX = 1202 - Float.valueOf(pad[1]) - paddleThreeLength;
			}
