...
//---------------------server------------------------------------------------------------
        ...
        DatagramPacket sendPacket1 = new DatagramPacket(sendData1,
                sendData1.length, InetAddress.getByName("192.168.0.108"), 7070);
...
//--------------------------------------------------------------------------------------
		...
		GameBoardPanel gameBoardPanel= new GameBoardPanel(ip2,port2,ip3,port3,ip4,port4,clientSocket1,receivePacket1);
